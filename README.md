...
1. **HackTheBox VIP/VIP+** (~$14–20/mo) — unlocks retired machines (most of TJ Null's list). Best paid upgrade for Phase 4.
2. **Proving Grounds Practice** (~$19/mo) — closest feel to the actual exam machines.
3. **TryHackMe Premium** (~$10–14/mo) — worth it during Phases 1–3 for the structured paths; can cancel once you hit box-grinding.
4. **TCM Security – Practical Ethical Hacking** (~$30, frequent sales) — excellent cheap beginner-to-intermediate course. https://academy.tcm-sec.com/
5. **PEN-200 + OSCP exam** — the real thing. ~$1,649 for the 90-day course bundle, or a higher "Learn One" annual tier with a year of lab access + two exam attempts. **Buy this last.** Confirm current pricing/bundles at https://www.offsec.com/courses/pen-200/ (prices change often).
